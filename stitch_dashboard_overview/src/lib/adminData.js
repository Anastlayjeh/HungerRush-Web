...
export const mockAdminData = {
  ...
  orders: [
    { id: 8001, restaurant_id: 201, customer: { name: "Maya Hassan" }, restaurant: { id: 201, name: "Cedar Grill" }, total: 31.5, payment_status: "paid", status: "pending", created_at: daysAgo(0.1) },
    { id: 8002, restaurant_id: 202, customer: { name: "Rami Farah" }, restaurant: { id: 202, name: "Pizza Bloom" }, total: 18, payment_status: "paid", status: "delivered", created_at: daysAgo(1) },
    { id: 8003, restaurant_id: 203, customer: { name: "Nour Khalil" }, restaurant: { id: 203, name: "Saffron Bowl" }, total: 42.75, payment_status: "pending", status: "preparing", created_at: daysAgo(2) },
    { id: 8004, restaurant_id: 204, customer: { name: "Guest Order" }, restaurant: { id: 204, name: "Urban Wraps" }, total: 13.25, payment_status: "refunded", status: "cancelled", created_at: daysAgo(3) },
  ],
  reports: [
